...
public class GUIComponentOnline extends GuiAnimationComponent implements ActionListener, Serializable
{
	...
	//Timer for the glass staying broken before disappearing
	...
	private void doBreakGlass(){
		guiPart.msgPartBroken();
		timer.schedule(new TimerTask(){
		    public void run(){//this routine is like a message reception   
		    	guiPart.setVisible(false);
		    	guiPart = null;
		    	transducer.fireEvent(channel, TEvent.WORKSTATION_FINISHED_BREAKING_GLASS, null);
		    }
		}, (int)2000);
	}
	...
	public void eventFired(TChannel channel, TEvent event, Object[] args)
	{
		if (channel == this.channel)
		{
			...
			if(event == TEvent.WORKSTATION_DO_BREAK_GLASS){
				animationState = AnimationState.IDLE;
				doBreakGlass();
				return;
			}
